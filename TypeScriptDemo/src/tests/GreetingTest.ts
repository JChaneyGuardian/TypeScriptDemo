...
describe('Greeting function', () => {
    ...
    it('should be able to use a SecurityIdentity object', () => {
        var person = new SecurityIdentity("Sam", "I", "Am", "siam");
    ...
    it('should be able to handled an undefined', () => {
        ...
        var result = Lib.greeting(undefined);
